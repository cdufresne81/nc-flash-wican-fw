...
| [bench-slcan-strand-2026-08.md](bench-slcan-strand-2026-08.md) | Dated snapshot (August 2026): the #92 Bench SLCAN strand -- the NC Flash probe-fallback hypothesis, what the logs do and do not prove, and the staged plan to reproduce it deterministically |
